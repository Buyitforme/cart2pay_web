         ...
         <div className="space-y-6">
             ...
             <div className="space-y-4">
               ...
               <div className=" pl-4 py-2">
                 ...
                 <p className="text-gray-600 text-sm leading-relaxed">
                   ...
                   allowing us to provide a more personalized experience.
                 </p>
               </div>
             </div>
           </div>
           ...
           <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8">
             ...
             <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
               <p className="text-gray-700 leading-relaxed">
                 ...
                 delete existing cookies. However, please note that disabling
           ...
           <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8">
             ...
             <p className="text-gray-600 leading-relaxed">
               ...
               will be reflected on this page, and we encourage you to review
               our policy periodically.
             </p>
           </div>

           {/* Contact Section */}
           <div className="bg-accent from-blue-600  rounded-lg shadow-sm text-white p-6 sm:p-8">
