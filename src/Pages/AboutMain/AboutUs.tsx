            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 px-4 lg:px-12 items-center">
              ...
              <div className="mt-6 lg:mt-0">
                <p className="text-white/90 text-base sm:text-lg leading-relaxed mb-4 max-w-lg">
                  Whether it’s securing that limited-edition item, saving time
                  on everyday purchases, or navigating complex international
            ...
            <SectionRenderer
              ...
              right={
                ...
                >
                  ...
                  >
                    Shopping should feel exciting, not stressful. With
                    ShopViaCal, you have a trusted partner to handle the details
                    from finding the right items to making secure purchases and
                    ensuring smooth delivery. We’re here to remove the worries
                    of international checkouts, confusing payments, or endless
