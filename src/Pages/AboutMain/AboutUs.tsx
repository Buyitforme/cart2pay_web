            ...
            left={
              ...
              >
                ...
                >
                  ...
                  ensures that every item you add is just a few steps from your
                  doorstep, without the frustration of forgotten purchases or
                  complicated payment processes. Whether you're a wholesaler or
                  a casual shopper, say goodbye to payment frustrations and
                  uncompleted transactions.{" "}
                  <span
                    className="inline-flex items-center text-primary font-semibold hover:underline cursor-pointer group"
