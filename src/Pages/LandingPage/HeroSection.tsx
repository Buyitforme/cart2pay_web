        ...
        <div className="pt-8 lg:pt-0 space-y-4">
          <div>
            <Heading
              ...
              weight="bold"
              className="md:leading-tight  md:text-start"
            >
          ...
          <Text size="lg" color="secondary" weight="extra_light" className=" ">
            Your personal shopping assistant at your fingertips. From rare finds
            to everyday essentials, we make shopping simple, fast, and
