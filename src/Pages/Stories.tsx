...
import StoryImage from "../Assets/svg_images/happy_ladies.jpg"; // replace with your own
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-6 mt-0 md:mt-12 lg:mt-24">
            ...
            <Text size="md" color="subtle">
              Stories from satisfied customers who’ve successfully paid for the
              items they purchased from stores like{" "}
