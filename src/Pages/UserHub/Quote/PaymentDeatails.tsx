...
export default function PaymentDeatails() {
  ...
  const handleViewOrder = () =>{
    setPaymentComfirmed(false)     
      navigate(`/dashboard/orders/order-details/${orderId}`)
  }
  return (
    <div className="flex items-center justify-center min-h-screen  sm:px-4 py-4 sm:py-8">
      <Card className="w-full max-w-sm sm:max-w-md lg:max-w-lg shadow-lg sm:shadow-2xl rounded-2xl sm:rounded-3xl border-0 backdrop-blur-sm bg-white/95">
        <div className=" sm:p-1 lg:p-2 flex flex-col items-center gap-4 sm:gap-6 lg:gap-8">
          {/* Trust Badge & Header */}
                ...
                <ol className="text-xs sm:text-sm text-blue-800 space-y-1.5 sm:space-y-2 leading-relaxed">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span className="min-w-0">
                      Click "I've Made Payment" below after completing the
                      transaction
                    </span>
                  </li>
                   <li className="flex items-start gap-2">
                    ...
                    <span className="min-w-0">
                      You will be notified once transaction is confirmed
                    </span>
                  </li>
                </ol>
              </div>
      ...
      >
        <div className="flex flex-col items-center justify-center  pb-5 max-w-md mx-auto">
          ...
          {/* Title */}
          <Heading size="lg" weight="bold" className="text-center">
          ...
          <Text
            size="sm"
            weight="normal"
            className="text-center text-gray-500 leading-relaxed break-words"
          >
            You'll be notified once transaction is confirmed.
          </Text>
